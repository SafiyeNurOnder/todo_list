...
"    background-image: url(:/icon/icons/background.jpeg);\n"
"    background-size: cover; /* veya contain */\n"
"    background-repeat: no-repeat;\n"
"    background-attachment: fixed; /* Sayfayı kaydırırken arka planın sabit kalmasını sağlar, isteğe bağlı */\n"
"}")
...
"}")
        ...
        self.label_8.setGeometry(QtCore.QRect(10, 10, 681, 81))
...
"font: 11pt;")
        ...
        self.widget_2.setGeometry(QtCore.QRect(30, 120, 651, 401))
...
"}")
        ...
        self.listWidget.setGeometry(QtCore.QRect(370, 80, 261, 231))
        self.listWidget.setObjectName("listWidget")
        self.pushButton_deletetask_2 = QtWidgets.QPushButton(self.widget_2)
        self.pushButton_deletetask_2.setGeometry(QtCore.QRect(370, 330, 261, 41))
        self.pushButton_deletetask_2.setStyleSheet("")
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/icon_add/icons/delete_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon8.addPixmap(QtGui.QPixmap(":/icon_add/icons/delete_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.pushButton_deletetask_2.setIcon(icon8)
        self.pushButton_deletetask_2.setObjectName("pushButton_deletetask_2")
        self.pushButton_addnew = QtWidgets.QPushButton(self.widget_2)
        self.pushButton_addnew.setGeometry(QtCore.QRect(530, 20, 101, 41))
        ...
        self.comboBox_addnewtask.setGeometry(QtCore.QRect(370, 30, 151, 30))
...
"}")
        ...
        self.layoutWidget_3.setGeometry(QtCore.QRect(260, 30, 451, 42))
        ...
        self.layoutWidget_4.setGeometry(QtCore.QRect(0, 490, 711, 40))
        ...
        self.pushButton_deletetask.setIcon(icon8)
        ...
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap(":/icon_add/icons/update_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon16.addPixmap(QtGui.QPixmap(":/icon_add/icons/update_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.pushButton_updatetask.setIcon(icon16)
        ...
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap(":/icon_add/icons/list_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon17.addPixmap(QtGui.QPixmap(":/icon_add/icons/list_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.pushButton_listtask.setIcon(icon17)
        ...
        self.listWidget_task.setGeometry(QtCore.QRect(260, 90, 451, 341))
...
"}")
        ...
        self.pButton_changepassword.setIcon(icon16)
        ...
        icon18 = QtGui.QIcon()
        icon18.addPixmap(QtGui.QPixmap(":/icon/icons/logout_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon18.addPixmap(QtGui.QPixmap(":/icon/icons/logout_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.pButton_logout.setIcon(icon18)
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_deletetask_2.setText(_translate("MainWindow", "Delete Task"))
