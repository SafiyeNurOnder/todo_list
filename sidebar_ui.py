...
"}")
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icon/icons/settings-icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon3.addPixmap(QtGui.QPixmap(":/icon/icons/settings-icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
...
"}")
        ...
        self.label_7.setGeometry(QtCore.QRect(260, 210, 191, 51))
        font = QtGui.QFont()
        font.setPointSize(20)
        font.setBold(True)
        font.setWeight(75)
...
"}")
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/newPrefix/icons/settings-icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon8.addPixmap(QtGui.QPixmap(":/icon/icons/settings-icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.pushButton_settings2.setIcon(icon8)
